...
5. **Installers**: At this point, the install process is manual, requiring basic comfort with the command line. We will be creating more user friendly installers. 
...
1. Download the [release](https://github.com/johnmidgley/opencola-alpha/releases/download/v0.1.4-alpha/opencola-v0.1.4-alpha.zip)
